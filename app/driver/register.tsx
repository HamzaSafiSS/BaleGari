  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (userError) {
        ...
        Alert.alert('Registration Failed', 'Could not create user profile. ' + userError.message);
        setLoading(false);
        return;
      }
      ...
      if (error) {
        if (error.code === '23505') { // Unique constraint violation for plate_number usually
          Alert.alert('Registration Failed', 'This plate number is already registered.');
        } else {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.inputWrapper}>
                <MaterialIcons name="directions-car" size={20} color="#999" style={styles.icon} />
                <TextInput
                  style={styles.input}
